...
class SerialBatchDetails extends StatefulWidget {
  const SerialBatchDetails({super.key,required this.docentry,required this.formkey});
  final int docentry;
      ...
      child: SingleChildScrollView(
                        ...
                        readOnly:
                            context.watch<AuditCtrlProvider>().freezeItemCode == true
                                ...
                                onChanged: (v){
                                  if(v.isNotEmpty){
                                    log("hiiii");
                                     if(context.read<AuditCtrlProvider>().freezeItemCode == false){
                                setState(() {
                                   log("hiiii222");
                                   context.read<AuditCtrlProvider>(). serachitemcode=true;
                              context.read<AuditCtrlProvider>().   SearchFilteTab(v);
                                });
        ...
        context.read<AuditCtrlProvider>().disableKeyBoard(context);
                        ...
                        decoration: InputDecoration(
                          contentPadding: EdgeInsets.symmetric(
                              ...
                              suffixIcon: IconButton(
                                onPressed:context.watch<AuditCtrlProvider>().freezeItemCode == true
                                ?(){}: (){
                                   ScannerPageState.itemcodeScan = true;
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                ...
                                icon: Icon(Icons.qr_code_2_sharp,size:23,),
                                ),
                          labelText: 'Item Code',
                          labelStyle:
                                  ...
                                  if (context
                                    ...
                                    setState(() {
                                      context
                                          .read<AuditCtrlProvider>()
                                          .addscanneddata(0);
                                          context.read<AuditCtrlProvider>().bottomSheetafterscanserial(context, 
                                          theme, 
                                          int.parse(context
                                              .read<AuditCtrlProvider>()
             ...
             Positioned(
              ...
              child: Visibility(
                visible: context.watch<AuditCtrlProvider>(). serachitemcode,
                child: Container(
                  padding: EdgeInsets.symmetric(
                  ...
                  child: ListView.builder(
                    shrinkWrap: true,
                    itemCount: context.read<AuditCtrlProvider>().getheaderresultsearch.length,
                    itemBuilder: (ContextM,ind){
                      return InkWell(
                        onTap: (){
                          setState(() {
                            log("widget.docentry::"+widget.docentry.toString());
                            // Navigator.pop(context);
        // context.read<AuditCtrlProvider>().showingChecklistBottomSheet(context,theme);
        // context.read<AuditCtrlProvider>(). checkpopupnew(context,theme,context.read<AuditCtrlProvider>().getheaderresultsearch[ind].serailBatch.toString(),widget.docentry,);
        //context.read<AuditCtrlProvider>().getheaderresultsearch[ind].serailBatch.toString()
        context.read<AuditCtrlProvider>().mycontroller[4].text =context.read<AuditCtrlProvider>().getheaderresultsearch[ind].itemCode.toString();
      context.read<AuditCtrlProvider>(). serachitemcode=false;
       context.read<AuditCtrlProvider>().getcheckdata();
       context.read<AuditCtrlProvider>().disableKeyBoard(context);
        //  context.read<AuditCtrlProvider>().  serialBatch = context.read<AuditCtrlProvider>().mycontroller[3].text;
        //  context.read<AuditCtrlProvider>(). itemCode =context.read<AuditCtrlProvider>(). mycontroller[4].text;
        //  context.read<AuditCtrlProvider>(). scanTime =context.read<AuditCtrlProvider>(). config.currentDatepdf();
        //  context.read<AuditCtrlProvider>(). mycontroller[5].text = 1.toString();
        //  context.read<AuditCtrlProvider>(). itemName = =context.read<AuditCtrlProvider>().getheaderresultsearch[ind].toString();
                        // context.read<AuditCtrlProvider>().    checkAlreadyItem22(context,theme,context.read<AuditCtrlProvider>().mycontroller[3].text,widget.docentry,context
                        //               .read<AuditCtrlProvider>()
                        //               .formkey3);
                          });
                        },
                        child: Container(
                          ...
                          child: Column(
                            children: [
                            Text("${context.read<AuditCtrlProvider>().getheaderresultsearch[ind].itemCode.toString()}")
                         ,Divider()
                          ],),
