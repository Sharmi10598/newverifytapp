...
class DataTableSuccess extends StatefulWidget {
  DataTableSuccess({Key? key, required this.tablerColumn}) : super(key: key);

  List<ScanDataPost> tablerColumn = [];

  @override
  State<DataTableSuccess> createState() => _DataTableSuccessState();
}

class _DataTableSuccessState extends State<DataTableSuccess> {
  @override
