...
import '../../Model/DownloadDataModel/BindataModel.dart';

class GetBinMasterApi {
  static Future<GetAuditBinkModel> getData(String whsCode, String name) async {
    int resCode = 500;
    ...
    try {
      ...
      return GetAuditBinkModel.error(resCode, "$e");
    }
  }
}
