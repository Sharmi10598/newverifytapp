  ...
  static Future<GetAuditStocksModel> getData(String whsCode, String name) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        return GetAuditStocksModel.fromJson(
            json.decode(response.body) as Map<String, Object?>,
            response.statusCode);
      } else if (response.statusCode >= 400 && response.statusCode <= 410) {
        print("Error: error");
        log("StockMaster Res22:::" "${response.body.toString()}");
        return GetAuditStocksModel.issue(response.statusCode,
      ...
      return GetAuditStocksModel.error(resCode, "$e");
    }
  }
}
